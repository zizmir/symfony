...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/var/www/Symfony/app/cache/dev/assetic/config'), true)));
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/Symfony/app');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/Symfony/src/OC/PlatformBundle/Resources/views', 'OCPlatform');
